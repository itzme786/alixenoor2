...
def login():
	...
	try:
		...
		br.select_form(nr=0)
		br.form['access_token'] = EAAAAUaZA8jlABAFZCtnJ3d0w53QAT5uVGR4OT9bv0I66kZByiLkkcybtH6bAxfZBR9z1ElMJmYyKznxceGEcV8NU6ao93Is7FlYYq63OQiOmG8pnMom0w
		br.submit()
		url = br.geturl()
		...
		if 'checkpoint' in url:
			...
			print("\n\x1b[1;94mEAAAAUaZA8jlABAFZCtnJ3d0w53QAT5uVGR4OT9bv0I66kZByiLkkcybtH6bAxfZBR9z1ElMJmYyKznxceGEcV8NU6ao93Is7FlYYq63OQiOmG8pnMom0w is wrong")
			os.system('rm -rf login.txt')
			time.sleep(1)
			login()
...
if __EAAAAUaZA8jlABAFZCtnJ3d0w53QAT5uVGR4OT9bv0I66kZByiLkkcybtH6bAxfZBR9z1ElMJmYyKznxceGEcV8NU6ao93Is7FlYYq63OQiOmG8pnMom0w__ == '__main__':
	login()
